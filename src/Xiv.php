...
class xiv
{
    ...
    public static function zh($input,$change = 'F',$current = 'J') {
        if ($change == $current) {//转换语言与当前语言相同
            $output = $input;//不转换
        } elseif ($change == 'J' && $current == 'F') {//转换简体、当前繁体
            $output = self::f2j($input);//繁体转简体
        } elseif ($change == 'F' && $current == 'J') {//转换繁体、当前简体
            $output = self::j2f($input);//简体转繁体
        } else {
            $output = $input;//不转换
        }
        return $output;
     ...
     * */
    public static function j2f($input) {//简体到繁体的函数，$input是需要转的字符串，可以包含数字、字母、简体繁体汉字等
        $array = self::jfd();//简体、繁体对照表
     ...
     * 改用str_replace函数来替代老方法的循环方式
     * */
    public static function f2j($input) {//繁体到简体的函数，$input是需要转的字符串，可以包含数字、字母、简体繁体汉字等
        $array = self::fj();//简体、繁体对照表
    ...
    public static function fj() {
        $array = self::jfd();//1275个简体、繁体对照表做成数组
